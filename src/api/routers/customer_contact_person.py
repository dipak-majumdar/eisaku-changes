...
from api.deps import get_customer_contact as get_service
from models.enums import TimePeriodEnum
from services import CustomerContactPersonService as Service
from schemas import (
    ...
    CustomerContactPersonUpdate as UpdateSchema
)
...
async def create(
    ...
    - customer_id: UUID of the vendor (required)
    """
