...
from api.deps import get_vendor_contact_person_service as get_service
from models.enums import TimePeriodEnum
from services import ContactPersonService as Service
from schemas import (
    ContactPersonRead as ReadSchema, 
    ContactPersonList as ListSchema, 
    ContactPersonCreate as CreateSchema, 
    ContactPersonUpdate as UpdateSchema
)

CREATE_PERMISSION = 'contact_person.can_create'
CHANGE_PERMISSION = 'contact_person.can_change'
VIEW_PERMISSION = 'contact_person.can_view'
DELETE_PERMISSION = 'contact_person.can_delete'
...
async def create(
    ...
    - mobile: Contact person mobile number (required)
    - email: Contact person email (required)
    - vendor_id: UUID of the vendor (required)
    """
