...
from models import VehicleType as Model
...
OBJECT_NOT_FOUND = messages.VEHICLE_TYPE_NOT_FOUND
OBJECT_EXIST = messages.VEHICLE_TYPE_EXIST
OBJECT_DELETED = messages.VEHICLE_TYPE_DELETED
...
class Service:
    ...
    async def list(self, request: Request, page=1, size=10, search: str | None = None,time_period: TimePeriodEnum | None = None, 
        start_date: date | None = None, end_date: date | None = None, ) -> ListSchema:
